...
public class Cita_generada_exitosamente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cita_generada_exitosamente);
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                ...
                new Cita_generada_exitosamente.RetrieveFeedTaskGet().execute();
            } else {
        ...
        new Cita_generada_exitosamente.RetrieveFeedTaskNotificaciones().execute();
    }
    ...
    public void goMenu(View v){
        Intent i = new Intent(Cita_generada_exitosamente.this, Menu.class);
        startActivity(i);
    }
    public void goNotificaciones(View v){
        Intent i = new Intent(Cita_generada_exitosamente.this, Notificaciones.class);
        startActivity(i);
    }

    public void goCitas(View v){
        Intent i = new Intent(Cita_generada_exitosamente.this, Citas.class);
        startActivity(i);
    }
    ...
    public void goCancelar(View v){
        ...
        dialogo1.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogo1, int id) {
                ...
                new Cita_generada_exitosamente.RetrieveFeedTaskCita().execute();
