...
public class Detalle_evento_camara extends AppCompatActivity {
    ListView lv;
    ...
    public Detalle_evento_camara mActivity = this;
    public PagosAdapter _mascotasAdapter;

    public Detalle_evento_camara _activity = this;
...
imgFotoEvento
    ...
    public void cambiarFoto(View v){
        ...
        if((ContextCompat.checkSelfPermission(Detalle_evento_camara.this,
                Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
                || (ContextCompat.checkSelfPermission(Detalle_evento_camara.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED))

        {

            ActivityCompat.requestPermissions
                    (Detalle_evento_camara.this, new String[]{
    ...
    private class Upload extends AsyncTask<Void,Void,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            Intent i = new Intent(Detalle_evento_camara.this, Principal.class);
            startActivity(i);
        }
    }
    ...
    public void guardarFotoServidor(View v){
        ...
        new Detalle_evento_camara.RetrieveFeedTask().execute();
    }
    ...
    */
    ...
    public void goBack(View v){
        //Intent i = new Intent(Detalle_contrato.this, Lista_clientes.class);
        Intent i = new Intent(Detalle_evento_camara.this, Lista_contratos.class);
        startActivity(i);
    }
    public void goAgregarPago(View v){
        Intent i = new Intent(Detalle_evento_camara.this, Agregar_pago.class);
    ...
    public void goMenu(View v){
        Intent i = new Intent(Detalle_evento_camara.this, Menu.class);
        startActivity(i);
    }
