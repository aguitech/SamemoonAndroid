...
public class EditarCita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras == null){}else{
            id_cita = extras.getString("id_cita");
        }
        ...
        new EditarCita.RetrieveFeedTaskEdit().execute();

        _urlServicios = "http://hyperion.init-code.com/zungu/app/vt_obtener_servicios.php?id_veterinario=" + valueID;
        new EditarCita.RetrieveFeedTaskServicio().execute();

        _urlVeterinario = "http://hyperion.init-code.com/zungu/app/vt_get_redveterinarios2.php?idv=" + valueID;
        new EditarCita.RetrieveFeedTaskVeterinario().execute();

        _urlEditarCita = "http://hyperion.init-code.com/zungu/app/vt_get_cita.php?id_cita=" + id_cita;
        new EditarCita.RetrieveFeedTaskEditCita().execute();

        _urlNotificaciones = "http://hyperion.init-code.com/zungu/app/vt_get_numero_notificaciones.php?idv=" + valueID;
        new EditarCita.RetrieveFeedTaskNotificaciones().execute();
        ...
        btnMesDia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datepick = new DatePickerDialog(EditarCita.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        */
                        ...
                        Héctor Aguilar 25.Ene.2017

                        TimePickerDialog timepick = new TimePickerDialog(EditarCita.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
...
*/
    ...
    class RetrieveFeedTaskEditCita extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            try {
                Log.i("INFO url: ", _urlEditarCita);
                URL url = new URL(_urlEditarCita);
        ...
        protected void onPostExecute(String response) {
            if (response == null) {
                ...
                try {
                    ...
                    //btnCliente.setText(object.getString("nombre_usuario") + " - " + object.getString("nombre_mascota"));
                    btnCliente.setText(object.getString("nombre_usuario"));
                    btnMascota.setText(object.getString("nombre_mascota"));
                    btnServicio.setText(object.getString("nombre_servicio") + " - " + object.getString("duracion") + " min.");
                    ...
                    selMascota = object.getInt("id_mascota");
                    selServicio = object.getInt("id_servicio_veterinario");
                    selVeterinario = object.getInt("id_veterinariohijo");
    ...
    public void showClientList(View v){
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                ...
                new EditarCita.RetrieveFeedTaskMascota().execute();
            }
        });
    ...
    public void goMenu(View v){
        Intent i = new Intent(EditarCita.this, Menu.class);
        startActivity(i);
    }
    public void goNotificaciones(View v){
        Intent i = new Intent(EditarCita.this, Notificaciones.class);
        startActivity(i);
    }
    ...
    public void confirmar(View v){
        ...
        if(txtMotivoCita.getText().toString().length() < 1 || selVeterinario == 0 || selServicio == 0 || selCliente == 0 || btnHora.getText().toString().equals("Horario disponible") || btnMesDia.getText().toString().equals("Mes/Día")){
            ...
            //_url = "http://hyperion.init-code.com/zungu/app/vt_editar_cita.php?id_cita=" + URLEncoder.encode(id_cita) +"&id_usuario=" + Integer.toString(selCliente) + "&idvh=" + Integer.toString(selVeterinario) + "&id_servicio=" + Integer.toString(selServicio) + "&motivo="+ URLEncoder.encode(txtMotivoCita.getText().toString()) + "&fecha=" + URLEncoder.encode(btnMesDia.getText().toString()) + "&hora=" + URLEncoder.encode(btnHora.getText().toString()) + "&id_veterinario=" + String.valueOf(valueID);
            _url = "http://hyperion.init-code.com/zungu/app/vt_editar_cita.php?id_cita=" + URLEncoder.encode(id_cita) +"&id_usuario=" + Integer.toString(selCliente) + "&idvh=" + Integer.toString(selVeterinario) + "&id_servicio=" + Integer.toString(selServicio) + "&motivo="+ URLEncoder.encode(txtMotivoCita.getText().toString()) + "&fecha=" + URLEncoder.encode(btnMesDia.getText().toString()) + "&hora=" + URLEncoder.encode(btnHora.getText().toString()) + "&id_veterinario=" + String.valueOf(valueID) + "&id_mascota=" + Integer.toString(selMascota);
            new EditarCita.RetrieveFeedTask().execute();
        }
            ...
            if(response == null) {
                ...
                try {
                    ...
                    if(ID == 0){
                        ...
                        Intent i = new Intent(EditarCita.this, Cita_generada_exitosamente.class);
                        i.putExtra("id_cita", id_cita);
                        startActivity(i);

                        showMsg("Se ha editado la cita");
                    }
